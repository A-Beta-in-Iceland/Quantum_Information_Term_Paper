...
\end{align*}
Therefore, without the loss of generality, we can show through induction that performing a local one qubit scheme is equivalent to performing a global unitary transformation then measurement-only scheme.
\section{Conclusion}
